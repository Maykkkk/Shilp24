    ...
    <div className="outer-body faq-outer-body">
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <button class="accordion-button fs-4 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">The payment procedure will be online. You will have to report at the accommodation desk near the SHILP room with the email printout and the mandatory documents. Failing to bring any of the documents may lead to the cancellation of your accommodation.</div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                    ...
                    <div class="accordion-body">Confirmation is not confirmed till a confirmation mail is not received in 24 hours. If not received confirmation in 24 hours, then mail your transaction ID, SHILP ID, name, amount to shilp@itbhu.ac.in with the subject as Transaction ID :: team ID :: Confirmation mail not received.</div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">No, the accommodation charges do not include food facilities. Guests can purchase their meals from  hostel canteens or hostel messes at just INR 50 per meal.</div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                    ...
                    <div class="accordion-body"> You can also eat in the many canteens, messes inside the campus.</div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                    ...
                    <div class="accordion-body">You can enter IIT Main gate anytime by showing a valid photo ID proof during 6am to 10pm, however, you need to have accommodation inside the campus to stay in the campus after 10pm.</div>
                    </div>
                </div>
                <div class="accordion-item">
                    <h2 class="accordion-header">
                    <button class="accordion-button collapsed fs-4" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseEleven" aria-expanded="false" aria-controls="flush-collapseEleven">
                    ...
                    <div class="accordion-body">No confirmation of accommodation will be provided. It is completely subject to the availability of rooms.</div>
                    </div>
                </div>
            </div>
    </div>
